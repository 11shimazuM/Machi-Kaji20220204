...
<title>お問い合わせ</title>
  ...
  <link rel="stylesheet" href="styles/reset.min.css">
    ...
    <body>
<form action="toiawasekakunin.php" method="post" >
   <br><main class= "label-title">◯　お問い合わせ　◯</main><br><br>
<!-- ご利用目的 -->
<div class="mb-3">
  <label class="form-label">お問い合わせの種類</label><br>
...
<div class="mb-3">
  ...
  <div class="item">
    <input type="text" class="form-control" name="mail" size="30" value="" placeholder="例) machi@kaji.jp" autocomplete="mail" required autofocus /><br>
  </div>
</div>
<!-- LINE ID -->
<div class="mb-3">
